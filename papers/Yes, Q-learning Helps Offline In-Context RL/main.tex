...
\centering
    ...
    % For continuous-action settings, the Q-heads accept an action value as input, whereas in discrete tasks they simultaneously predict values for all possible actions, following common practice. 
...
% However, it is worth noting that we did not tune hyperparameters for DQN and reused parameters from CQL, so the DQN's performance has a potential for improvement. 
...
%     \item[] Justification: Abstract and introduction are supported by sections 2, 3, 4, 5 and appendix.
%     \item[] Guidelines:
%     \begin{itemize}
...
%     \item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
%     \item[] Justification: Sections 4, 5 and appendix discuss limitations and potential future work.
%     \item[] Guidelines:
%     \begin{itemize}
...
%     \item[] Justification: Our paper does not contain theoretical results.
%     \item[] Guidelines:
%     \begin{itemize}
...
%     \item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
%     \item[] Justification: We provide all of the experimental descriptions in Sections 3, 4, and the appendix. We will also share our codebase.
%     \item[] Guidelines:
%     \begin{itemize}
...
%     \item[] Justification: We will make the code public after publication of the paper.
%     \item[] Guidelines:
%     \begin{itemize}
...
%     \item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
%     \item[] Justification: See Sections 3, 4 and appendix.
%     \item[] Guidelines:
%     \begin{itemize}
%         \item The answer NA means that the paper does not include experiments.
...
%     \item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
%     \item[] Justification: We run all experiments using multiple random seeds and report rliable metrics that demonstrate the statistical significance of our results.
%     \item[] Guidelines:
%     \begin{itemize}
%         \item The answer NA means that the paper does not include experiments.
...
%     \item[] Answer: \answerNA{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
%     \item[] Justification: We provide information about GPU but not the exact compute time due to the large amount of experiments.
%     \item[] Guidelines:
%     \begin{itemize}
%         \item The answer NA means that the paper does not include experiments.
...
%     \item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
%     \item[] Justification: We follow NeurIPS Code of Ethics.
%     \item[] Guidelines:
%     \begin{itemize}
...
%     \item[] Answer: \answerNA{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
%     \item[] Justification: There is no any direct societal impact.
%     \item[] Guidelines:
%     \begin{itemize}
...
%     \item[] Answer: \answerYes{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
%     \item[] Justification: We provide references for all of the used assets.
%     \item[] Guidelines:
%     \begin{itemize}
...
%     \item[] Answer: \answerNA{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
%     \item[] Justification: Our paper will provide only the codebase for experiments reproduction.
%     \item[] Guidelines:
%     \begin{itemize}
...
%     \item[] Answer: \answerNA{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
%     \item[] Justification: No crowdsourcing is involved.
%     \item[] Guidelines:
%     \begin{itemize}
...
%     %this research? 
%     \item[] Answer: \answerNA{} % Replace by \answerYes{}, \answerNo{}, or \answerNA{}.
%     \item[] Justification: LLMs were not used for research.
%     \item[] Guidelines:
%     \begin{itemize}
